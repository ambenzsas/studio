...
const features = [
  {
    ...
    title: "Repuestos Originales y Homologados",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            En AM BENZ, somos tu aliado de confianza. Nos dedicamos a proveer exclusivamente repuestos de la más alta calidad para que tu vehículo mantenga el rendimiento, la seguridad y la elegancia con la que fue diseñado.
          </p>
        </div>
