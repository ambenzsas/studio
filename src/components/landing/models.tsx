...
export default function Models() {
  return (
    <section id="logos" className="py-20 bg-background">
      <div className="container mx-auto px-6">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Desde sedanes de lujo y SUVs hasta los modelos de alto rendimiento y eléctricos.
          </p>
        </div>
        <div className="mb-16 grid grid-cols-2 items-center gap-8 md:grid-cols-3 max-w-4xl mx-auto">
